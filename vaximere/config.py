...
TARGET_PER_INTENT_FR: int = 100  # questions FR maîtresses par intention (dataset v2)
AUGMENT_PARAPHRASES: int = 1     # nb de paraphrases back-translation par question
